...
CREATE TABLE IF NOT EXISTS `mydb`.`SETORES` (
  `idSETORES` INT NOT NULL,
  `nome` VARCHAR(100) NOT NULL,
  `qtd_colaboradores` VARCHAR(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`COLABORADORES` (
  ...
  `COLABORADOREScol` VARCHAR(45) NOT NULL,
  `SETORES_idSETORES` INT NOT NULL,
  PRIMARY KEY (`idCOLABORADORES`),
  INDEX `fk_COLABORADORES_SETORES1_idx` (`SETORES_idSETORES` ASC) VISIBLE,
  CONSTRAINT `fk_COLABORADORES_SETORES1`
    FOREIGN KEY (`SETORES_idSETORES`)
    REFERENCES `mydb`.`SETORES` (`idSETORES`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `mydb`.`DANFE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`DANFE` (
  `idDANFE` INT NOT NULL,
  `numero_nfe` VARCHAR(45) NOT NULL,
  `serie_nfe` VARCHAR(45) NOT NULL,
  `data_emissao` DATE NOT NULL,
  `valor_total` DECIMAL(10,2) NOT NULL,
  `chave_eletronica` VARCHAR(45) NOT NULL,
  `proto_autori` VARCHAR(45) NOT NULL,
  `DANFEcol` VARCHAR(45) NOT NULL,
  `CLIENTES_idCLIENTES` INT NOT NULL,
  PRIMARY KEY (`idDANFE`),
  INDEX `fk_DANFE_CLIENTES1_idx` (`CLIENTES_idCLIENTES` ASC) VISIBLE,
  CONSTRAINT `fk_DANFE_CLIENTES1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`VENDAS` (
  ...
  `Valor_total` DECIMAL(10,2) NOT NULL,
  `Qtd_livros` VARCHAR(5) NOT NULL,
  `COLABORADORES_idCOLABORADORES` INT NOT NULL,
  `DANFE_idDANFE` INT NOT NULL,
  `CLIENTES_idCLIENTES` INT NOT NULL,
  PRIMARY KEY (`idVENDAS`),
  INDEX `fk_VENDAS_COLABORADORES1_idx` (`COLABORADORES_idCOLABORADORES` ASC) VISIBLE,
  INDEX `fk_VENDAS_DANFE1_idx` (`DANFE_idDANFE` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_VENDAS_COLABORADORES1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_VENDAS_DANFE1`
    FOREIGN KEY (`DANFE_idDANFE`)
    REFERENCES `mydb`.`DANFE` (`idDANFE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`AUTORES_has_LIVROS` (
  ...
  INDEX `fk_AUTORES_has_LIVROS_AUTORES1_idx` (`AUTORES_idAUTORES` ASC) VISIBLE,
